...
class FallbackDB:
    ...
    async def has_recent_incident(self, train_number, minutes=2):
        # By architectural mandate, we rely entirely on unique compound indexes
        # and DuplicateKeyError for database idempotency rather than expensive query-based checks.
        return False
